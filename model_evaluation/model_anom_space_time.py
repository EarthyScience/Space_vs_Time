...
for i in range(5):
    ...
    for j in range(num_years):
        ...
        # calculate IG
        ig_space[i, j, :] = calc_ig(
            igmod_space, sample_feat, sample_stat, site_mean_feat, site_mean_stat
        )
        ig_time[i, j, :] = calc_ig(
            igmod_time, sample_feat, sample_stat, site_mean_feat, site_mean_stat
        )
